...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f0c29,50:302b63,100:24243e&height=200&section=header&text=Anurag%20Kumar%20Upadhyay&fontSize=45&fontColor=ffffff&fontAlignY=38&desc=Data%20Analyst%20%7C%20AI%2FML%20Engineer%20%7C%20Full%20Stack%20Developer&descAlignY=58&descSize=18&animation=fadeIn" />

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=A78BFA&center=true&vCenter=true&width=600&lines=Building+AI-Powered+Applications+%F0%9F%A4%96;Turning+Data+into+Decisions+%F0%9F%93%8A;Machine+Learning+%7C+Full+Stack+%7C+Computer+Vision;Open+to+Collaborate+%E2%9C%A8)](https://git.io/typing-svg)
...
```python
class AnuragKumarUpadhyay:
    def __init__(self):
        self.name        = "Anurag Kumar Upadhyay"
        self.role        = "Aspiring Data Analyst"
        self.focus       = ["Data Science", "AI/ML", "Full Stack Dev"]
        self.tools       = ["Python", "React", "FastAPI", "PostgreSQL"]
        self.currently   = "Building real-world AI-powered systems"
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Full-stack AI-powered interview simulator with resume-based dynamic Q&A, live webcam integration via WebRTC, conversational memory, and performance analytics dashboards.</p>
      <p>
    ...
    <td width="50%" valign="top">
      ...
      <p>Web app digitally showcasing herbal plants and their medicinal properties. Features structured plant data management, email interaction, and PostgreSQL-backed database architecture.</p>
      <p>
  ...
  <tr>
    <td width="50%" valign="top">
      <h3>👁️ Face Recognition Attendance System</h3>
      <p>Real-time classroom attendance system using Haar cascade classifiers and OpenCV. Automatically marks attendance and sends SMTP email alerts to absent students.</p>
      <p>
    ...
    <td width="50%" valign="top">
      ...
      <p>ML regression model with NLP & embeddings to predict personalized property prices. Exposed via a FastAPI backend for seamless integration and scalability.</p>
      <p>
